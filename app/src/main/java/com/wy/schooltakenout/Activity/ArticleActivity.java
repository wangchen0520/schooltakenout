...
public class ArticleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        icarus = new Icarus(toolbar, options, mWebView);
        icarus.setContent(
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.dianzan: Log.d(TAG,"dianzan");break;
            case R.id.comment:Log.d(TAG,"comment");break;
            case R.id.collection:Log.d(TAG,"collection");break;
            case R.id.share:Log.d(TAG,"share");break;
            default:
        }
        return true;
    }
